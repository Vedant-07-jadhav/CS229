...
def build_config() -> dict[str, str]:
    ...
    return dict(
        ...
        python_path=r"/home/vedant/Codes&Projects/CS229/Env_CS229/bin/python",
        ...
        # Misc meson settings
        meson_backend="ninja",
        build_dir=r"/croot/contourpy_1732540045555/work/.mesonpy-cbja7ase/lib/contourpy/util",
        source_dir=r"/croot/contourpy_1732540045555/work/lib/contourpy/util",
        cross_build="False",

        # Build options
        build_options=r"-Dbuildtype=release -Db_ndebug=if-release -Db_vscrt=md -Dvsenv=True --native-file=/croot/contourpy_1732540045555/work/.mesonpy-cbja7ase/meson-python-native-file.ini",
        buildtype="release",
        cpp_std="c++17",
        debug="False",
        optimization="3",
        ...
        linker_id="ld.bfd",
        compile_command="/croot/contourpy_1732540045555/_build_env/bin/x86_64-conda-linux-gnu-c++",
