...
TCL_CC='/croot/tk_1748849386456/_build_env/bin/x86_64-conda-linux-gnu-cc'
...
# installed.
TCL_PREFIX='/home/vedant/Codes&Projects/CS229/Env_CS229'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/home/vedant/Codes&Projects/CS229/Env_CS229'
...
TCL_EXTRA_CFLAGS='-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /home/vedant/Codes&Projects/CS229/Env_CS229/include -fdebug-prefix-map=/croot/tk_1748849386456/work=/usr/local/src/conda/tk-8.6.14 -fdebug-prefix-map=/home/vedant/Codes&Projects/CS229/Env_CS229=/usr/local/src/conda-prefix -pipe -m64 -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /home/vedant/Codes&Projects/CS229/Env_CS229/include'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,-rpath,/home/vedant/Codes&Projects/CS229/Env_CS229/lib -Wl,-rpath-link,/home/vedant/Codes&Projects/CS229/Env_CS229/lib -L/home/vedant/Codes&Projects/CS229/Env_CS229/lib -Wl,--export-dynamic '
...
TCL_RANLIB='/croot/tk_1748849386456/_build_env/bin/x86_64-conda-linux-gnu-ranlib'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/croot/tk_1748849386456/work/tcl8.6.14/unix -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/home/vedant/Codes&Projects/CS229/Env_CS229/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/home/vedant/Codes&Projects/CS229/Env_CS229/include'
...
# compiled.
TCL_SRC_DIR='/croot/tk_1748849386456/work/tcl8.6.14'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='{/home/vedant/Codes&Projects/CS229/Env_CS229/lib} '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/croot/tk_1748849386456/work/tcl8.6.14/unix -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/home/vedant/Codes&Projects/CS229/Env_CS229/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/croot/tk_1748849386456/work/tcl8.6.14/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/home/vedant/Codes&Projects/CS229/Env_CS229/lib/libtclstub8.6.a'
