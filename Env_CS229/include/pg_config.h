...
#define CONFIGURE_ARGS " '--prefix=/home/vedant/Codes&Projects/CS229/Env_CS229' '--with-readline' '--with-libraries=/home/vedant/Codes&Projects/CS229/Env_CS229/lib' '--with-includes=/home/vedant/Codes&Projects/CS229/Env_CS229/include' '--with-openssl' '--with-gssapi' '--with-icu' '--with-libxml' '--with-libxslt' '--with-lz4' '--with-zstd' '--with-uuid=e2fs' '--with-system-tzdata=/home/vedant/Codes&Projects/CS229/Env_CS229/share/zoneinfo' '--with-ldap' 'PG_SYSROOT=undefined' 'build_alias=x86_64-conda-linux-gnu' 'host_alias=x86_64-conda-linux-gnu' 'CC=x86_64-conda-linux-gnu-cc' 'CFLAGS=-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /home/vedant/Codes&Projects/CS229/Env_CS229/include -fdebug-prefix-map=/croot/postgresql-split_1741123568549/work=/usr/local/src/conda/postgresql-split-17.4 -fdebug-prefix-map=/home/vedant/Codes&Projects/CS229/Env_CS229=/usr/local/src/conda-prefix' 'LDFLAGS=-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,-rpath,/home/vedant/Codes&Projects/CS229/Env_CS229/lib -Wl,-rpath-link,/home/vedant/Codes&Projects/CS229/Env_CS229/lib -L/home/vedant/Codes&Projects/CS229/Env_CS229/lib' 'CPPFLAGS=-DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /home/vedant/Codes&Projects/CS229/Env_CS229/include' 'CXX=' 'CPP=/croot/postgresql-split_1741123568549/_build_env/bin/x86_64-conda-linux-gnu-cpp' 'PKG_CONFIG_PATH=/home/vedant/Codes&Projects/CS229/Env_CS229/lib/pkgconfig'"
...
#define PG_VERSION_STR "PostgreSQL 17.4 on x86_64-conda-linux-gnu, compiled by x86_64-conda-linux-gnu-cc (Anaconda gcc) 11.2.0, 64-bit"
